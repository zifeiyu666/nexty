...
export async function generateMetadata({
  ...
  return constructMetadata({
    title: "Personalized Music Gifts for Music Lovers",
    description:
      "Create personalized music gifts for music lovers, kids, Christmas, and lyric keepsakes with custom songs, music videos, and printable wall art.",
    locale: locale as Locale,
    path: "/occasions/music-gift",
